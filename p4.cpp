...
const char *WINDOWTITLE = { "Project4 - Raymond" };
...
Display( )
{
    ...
    glTranslatef(5 * cos(2 * M_PI * Time), 0., 6.);
    ...
    //light0
    SetSpotLight(GL_LIGHT0, 0, 0., 0, 0, 0., 10, 1., 0.1, 0.1);
    glPushMatrix();
    glDisable(GL_LIGHTING);
    glColor3f(1., 0.1, 0.1);
    ...
    //light1
    SetPointLight(GL_LIGHT1, 0., 0., 9., 1.0, 1.0, 1.0);
    glPushMatrix();
    glDisable(GL_LIGHTING);
    ...
    //light2
    SetPointLight(GL_LIGHT2, 8 * cos(2 * M_PI * Time), 5., 8 * sin(2 * M_PI * Time), 0., 0.7, 0);
    glPushMatrix();
    glDisable(GL_LIGHTING);
    glColor3f(0., 0.7, 0);
    glTranslatef(0., 5., 0.);
    ...
    glDisable(GL_LIGHTING);
    glColor3f( 1., 1., 1. );
    DoRasterString( 5., 5., 0., "Raymond Yuan - Lighting" );
